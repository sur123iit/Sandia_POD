%%
%This program plots RMS velocities for different techniques for 20% energy
%%
clear all;
%%
...
eig4 = eig5(1:599,1);
m_index = m_index(1:599,1);%1669 for 75 % 2941 for 80 %
f_index = f_index(1:599,1);
...
folderName = 'Y:\rawdata\Sandia_cavity\SpectralVelocityReconstructions\DecreasingEnergy\65Energy_599modes\';
