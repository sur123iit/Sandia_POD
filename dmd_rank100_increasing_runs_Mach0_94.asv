...
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Rank40\';
...
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Rank15\';
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
saveFile = strcat('eigval_',int2str(ens_num),'.mat');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Rank50\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Rank100\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Rank150\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Rank200\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
