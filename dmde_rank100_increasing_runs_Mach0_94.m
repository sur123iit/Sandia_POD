...
clear all;
%% Load Data
[ L,D,Ma,Uinf,Fs,N,Nb ] = load_parameters(3);
...
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Exact\Rank40\';
...
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Exact\Rank15\';
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
saveFile = strcat('eigval_',int2str(ens_num),'.mat');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Exact\Rank50\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Exact\Rank100\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Exact\Rank150\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
...
% Save modes
%%%%%
saveFolder = 'Y:\rawdata\Sandia_cavity\DMD\Convergence\Mach0.94\Exact\Rank200\';
%%%%
saveFile = strcat('freq_',int2str(ens_num),'.txt');
saveComplete = strcat(saveFolder,saveFile);
save(saveComplete,'dmd_freq','-ascii');
